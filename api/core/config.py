...
class TelegramConfig:
    ...
    def from_env(cls) -> "TelegramConfig":
        ...
        if bot_token:
            if len(bot_token) > 8:
                ...
                masked_token = "****"
            effective_ch = sandbox_channel_id if sandbox and sandbox_channel_id else channel_id
            print(f"[TelegramConfig] bot_token={masked_token}, channel_id={channel_id}, "
    ...
    def effective_channel_id(self) -> int:
        ...
        return self.sandbox_channel_id if self.sandbox and self.sandbox_channel_id else self.channel_id
