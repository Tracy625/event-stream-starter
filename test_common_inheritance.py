...
def test_diagnostic_with_last_checked():
    ...
    try:
        ...
        print(
            "   This proves the diagnostic definition is inherited from common.schema.json"
        )
        return True
...
def test_pushcard_states():
    ...
    test_pushcard = {
        ...
        "sources": {"security_source": "GoPlus", "dex_source": "Uniswap"},
        "states": {
            "cache": False,
            "degrade": False,
            "stale": False,
    ...
    try:
        ...
        print(
            "   This proves the states definition is inherited from common.schema.json"
        )
        return True
    except jsonschema.ValidationError as e:
        print(f"❌ Validation failed: {e.message}")
...
if __name__ == "__main__":
    ...
    if test1 and test2:
        ...
        print(
            "2. Both cards.schema.json and pushcard.schema.json use the shared definitions"
        )
        print(
            "3. Adding fields like 'last_checked' to common diagnosticFlags affects all consumers"
        )
    else:
